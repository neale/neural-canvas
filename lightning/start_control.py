...
from lightning_generators import INRLinearMap
    ...
    while True:
            if kb.kbhit():
                ...
                if c == 27: # ESC
                    ...
                    print ('[w8] Changing mlp layer width to 8...')
                    runner.model.mlp_layer_width = 8
                    runner.model.map_fn = reset_model()
                elif c == 102:
                    print ('[w16] Changing mlp layer width to 16...')
                    runner.model.mlp_layer_width = 16
                    runner.model.map_fn = reset_model()
                elif c == 103:
                    print ('[w32] Changing mlp layer width to 32...')
                    runner.model.mlp_layer_width = 32
                    runner.model.map_fn = reset_model()
                elif c == 104:
                    print ('[w64] Changing mlp layer width to 64...')
                    runner.model.mlp_layer_width = 64
                    runner.model.map_fn = reset_model()
                elif c == 105:
                    print ('[s1] Changing latent scale to 1.0...')
                    scale = 1.0
                    fields = runner.model.construct_fields(
                        output_shape=(args.x_dim, args.y_dim), 
                        zoom=(zoom_x_curr, zoom_y_curr), 
                    ...
                    print ('[s2] Changing latent scale to 2.0...')
                    scale = 2.0
                    fields = runner.model.construct_fields(
                        output_shape=(args.x_dim, args.y_dim), 
                        zoom=(zoom_x_curr, zoom_y_curr), 
                    ...
                    print ('[s4] Changing latent scale to 4.0...')
                    scale = 4.0
                    runner.model.latent_scale = 64
                    fields = runner.model.construct_fields(
                        output_shape=(args.x_dim, args.y_dim), 
                        zoom=(zoom_x_curr, zoom_y_curr), 
                        pan=(pan_x_curr, pan_y_curr))
                elif c == 108:
                    print ('[s8] Changing latent scale to 8.0...')
                    runner.model.latent_scale = 8.0
                    fields = runner.model.construct_fields(
                        output_shape=(args.x_dim, args.y_dim), 
                        zoom=(zoom_x_curr, zoom_y_curr), 
                        pan=(pan_x_curr, pan_y_curr))
            ...
            frames = runner.model.generate(fields, latent_iter_curr)
